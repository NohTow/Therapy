...
logging.basicConfig(
    ...
    filename=("test_amazon.log".format(args.c, args.temperature, args.penalty, args.num_it, args.alpha))
)
...
black_box = pickle.load(open("reproduction/models/amazon_reglog", 'rb'))
vectorizer = pickle.load(open("reproduction/vectorizer/amazon_reglog", 'rb'))
...
def main():
    ...
    samples_pbar = tqdm(total = 2 * samples_size, desc="Samples generated")
    fieldnames = ['text', 'label']
    with open("amazon_mcts_{}_{}_{}_{}_{}.csv".format(args.c, args.temperature, args.penalty, args.num_it, args.alpha), "w") as output_file:
